        ...
        <div class="statistics-intro section-intro">
            ...
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'h6',
                    'tc' => 'statistics-title section-intro__title a-up'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'p',
                    'tc' => 'statistics__description section-intro__description a-up a-delay-1'
                )
            );
            ?>
        </div>
        ...
        <div class="portfolio-intro section-intro">
            ...
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'h6',
                    'tc' => 'portfolio-title section-intro__title a-up'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'p',
                    'tc' => 'portfolio__description section-intro__description a-up a-delay-1'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    'v'  => 'portfolio_cta',
                    'o'  => 'f',
                    'c'  => 'portfolio-cta section-intro__cta btn btn--dark a-up a-delay-1'
                )
            );
            ?>
        </div>
        ...
        <div class="services-intro section-intro">
            ...
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'h6',
                    'tc' => 'services-title section-intro__title a-up'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'p',
                    'tc' => 'services__description section-intro__description a-up a-delay-1'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    'v'  => 'services_cta',
                    'o'  => 'f',
                    'c'  => 'services-cta section-intro__cta btn btn--dark a-up a-delay-1'
                )
            );
            ?>
        </div>
        ...
        <div class="brands-intro section-intro">
            ...
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'h6',
                    'tc' => 'brands-title section-intro__title a-up'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'p',
                    'tc' => 'brands-description section-intro__description a-up a-delay-1'
                )
            );
            ?>
        </div>
        ...
        <div class="news-intro section-intro">
            ...
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'h6',
                    'tc' => 'news-title section-intro__title a-up'
                )
            );
            ?>
            <?php
            get_template_part_args(
                ...
                array(
                    ...
                    'o'  => 'f',
                    't'  => 'p',
                    'tc' => 'news__description section-intro__description a-up a-delay-1'
                )
            );
            ?>
        </div>
